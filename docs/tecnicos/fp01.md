...
---
Para empezar con la fabricación de las piezas de la consigna, descargamos el programa RDworsV8; es el programa de la cortadora láser y desde allí se configuran las variables correspondientes a los parámetros de diseño buscados. 
Se establece el tamaño de la placa de MDF, el espesor y el punto de origen de la cama de la máquina. 

![](../images/FP01-f.jpg)

Es recomendable que el origen esté sobre el punto más lejano por un tema de seguridad hasta tener mayor dominio de la tecnología. Revisamos los parámetros de distancia óptima del lente y la superficie de la placa para controlar más eficientemente el enfoque del láser.

![](../images/FP01-g.jpg)

Verifique que los valores de las capas, como el color, estuvieran ordenados según la convención para cortar, marcar o rasterizar: negro, rojo y verde, respectivamente. Luego marque la potencia del láser en porcentaje para cada capa y la velocidad de trabajo. 

![](../images/FP01-h.jpg)

El orden de las capas determina qué proceso hará la máquina primero. La recomendación de los docentes es que primero se hagan los resterizados, enseguida los marcados y, por último, los cortes.
