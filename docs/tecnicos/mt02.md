...
*Video captura de rotación del modelo en autocad*
...
# **Lámina de presentación del producto**

![](../images/MT02-m.jpg)
Remderizado final realizado en 3dmax con modelado en autocad.
Esto lo hice para mejorar la lamina de presentacion que se entrego en el archivo pdf que se subio a Moodle.
...
<p align="right">Logré parametrizar en grasshoper algunos comands, asi que voy a contar los avances en rhinocero. La logica de la interfaz tiene valores fijos para figuras como un circulo, con dos entradas uno corresponde la radio y otro al plano donde se inscribe. Asi se puede ir interconectando entradas y salidas para controlar la forma.</p>


![](../images/Rhino-Grasshopper.jpg)

---

**Referencias**

Iker Libano - diseñando piezas complejas en Fusion 360
